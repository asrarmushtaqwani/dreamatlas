...
export default function LoginPage() {
  ...
  return (
    <AuthShell
      ...
      subheading="The atlas has been waiting."
      footer={<>New here? <Link href="/auth/signup" style={{ color: 'var(--accent-light)', textDecoration: 'none' }}>Create account</Link></>}
    >
      <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <Field label="Password">
          <input className="text-input" type="password" placeholder="your password"
