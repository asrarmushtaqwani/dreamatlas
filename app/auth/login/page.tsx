...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px 16px', position: 'relative' }}>
      {/* Ambient */}
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 400, animation: 'scaleIn 0.45s cubic-bezier(0.16,1,0.3,1) both' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: 22, padding: '36px 30px', boxShadow: '0 24px 60px rgba(0,0,0,0.5)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <h1 style={{ fontFamily: FONT_DISPLAY, fontSize: 30, fontWeight: 700, fontStyle: 'italic', color: '#f0ece6', marginBottom: 6, letterSpacing: '-0.02em' }}>Welcome back</h1>
            <p style={{ fontSize: 14, color: 'rgba(240,236,230,0.4)', fontFamily: FONT_SERIF, fontStyle: 'italic' }}>The atlas has been waiting.</p>
          </div>
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input className="text-input" type="password" placeholder="your password" value={password} onChange={e => setPassword(e.target.value)} required />
            </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 18, fontSize: 13, color: 'rgba(240,236,230,0.28)' }}>
          New here?{' '}
          <Link href="/auth/signup" style={{ color: ACCENT, textDecoration: 'none' }}>Create account</Link>
        </p>
      </div>
